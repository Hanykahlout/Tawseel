...
class WelcomeViewController: UIViewController {
    ...
    private func setData() {
        data.append((image: #imageLiteral(resourceName: "i1"),imageHeightConstant : 195, title: NSLocalizedString("Ask for the closest", comment: ""), details: NSLocalizedString("Ask for the closest_Content", comment: "")))
        data.append((image: #imageLiteral(resourceName: "i2"),imageHeightConstant : 300 , title: NSLocalizedString("Electronic payment", comment: ""), details: NSLocalizedString("Electronic payment_Content", comment: "")))
        data.append((image: #imageLiteral(resourceName: "i3"),imageHeightConstant : 265 , title: NSLocalizedString("join us", comment: ""), details: NSLocalizedString("join us_Content", comment: "")))
    }
